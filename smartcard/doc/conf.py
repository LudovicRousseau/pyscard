...
latex_documents = [
  ('index', 'pyscard.tex', 'pyscard Documentation',
   'Ludovic Rousseau', 'manual'),
]
...
man_pages = [
    ('index', 'pyscard', 'pyscard Documentation',
     ['Ludovic Rousseau'], 1)
]
...
texinfo_documents = [
  ('index', 'pyscard', 'pyscard Documentation',
   'Ludovic Rousseau', 'pyscard', 'One line description of project.',
   'Miscellaneous'),
]
